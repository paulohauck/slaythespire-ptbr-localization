...
The following tables shows the Words/Expressions adaptations to fill better in the Brazilian cultural scenario. If you dont agree with any localized term or have a better suggestion, please let us know.

## Characters | Personagens
| English                  | Brazilian Portuguese | Reason |
| ------------------------ | -------------------- | ------ |
| (The) Ironclad           | (O) Rígido           | "Iron Clad" é literalmente "Revestido de Ferro". "Ironclad" também é um adjetivo significando "Rígido", "Inflexível".<sup>1</sup> |
| (The) Silent             | (A) Sorrateira       | 1. A personagem é mulher; 2. Uma caçadora; 3. Inspirada no arquétipo de fantasia "ladra".<sup>2</sup> |
| Neow                     | Neow                 |        |
| (The) Merchant           | (O) Vendedor         |        |
| Crowbot<sup>3</sup>      | Corvobô              | Crow é literalmente corvo. O "bot" vem da palavra "robot", que em português é "robô". |
...
> P.S.: É importante manter a consistência nas cartas com "Strike" no nome, para não gerar confusões com a carta "Perfected Strike"
...
| -------- | -------------------- | ------ |
| Attack   | Ataque               |        |
| Skill    | Técninca             | "Habilidade" é grande demais, e acaba ficando fora da caixa de tipo da carta |
| Power    | Poder                |        |
| Curse    | Maldição             |        |
| Status   | Condição             |        |
...
| Twin Strike      | Golpe Duplo             |        |
| Warcry           | Grito de Guerra         |        |
| Wild Strike      | Golpe Selvagem          |        |

><sup>1</sup> [Wikipédia](https://pt.wikipedia.org/wiki/Ataques_de_luta_profissional#Clothesline)

#### Uncommon | Incomum

| English         | Brazilian Portuguese  | Reason |
| --------------- | --------------------- | ------ |
| Battle Trance   | Êxtase de Batalha     |        |
| Blood for Blood | Sangue por Sangue     |        |
| Bloodletting    | Sangria               |        |
| Burning Pact    | Pacto Ardente         |        |
| Carnage         | Carnificina           |        |
| Combust         | Combustão             |        |
| Corruption      | Corrupção             |        |
| Disarm          | Desarmar              |        |
| Dropkick        | Voadora               |        |
| Entrench        | Entricheirar          |        |
| Evolve          | Evoluir               |        |
| Feel No Pain    | Não Sentir Dor        |        |
| Fire Breathing  | Cuspir Fogo           |        |
...
| Infernal Blade  | Lâmina Infernal       |        |
| Inflame         | Inflamar              |        |
| Intimidate      | Intimidar             |        |
| Metallicize     | Metalizar             |        |
| Power Through   | Resistir              |        |
| Pummel          | Esmurrar              |        |
| Rage            | Raiva                 |        |
| Rampage         | Fúria                 |        |
| Reckless Charge | Investida Imprudente  | <sup>1</sup> |
| Rupture         | Ruptura               |        |
| Searing Blow    | Pancada Cauterizante  |        |
| Second Wind     | Fôlego Extra          |        |
| Seeing Red      | Cego de Raiva         | Expressão em português equivalente. |
| Sentinel        | Sentinela             |        |
...
><sup>1</sup> [Magic: the Gathering](https://imgur.com/a/N14XF)
...
| Feed         | Comer                |        |
| Fiend Fire   | Chamas Demoníacas    |        |
| Immolate     | Imolar               |        |
| Impervious   | Impenetrável         |        |
| Juggernaut   | Juggernaut           | Juggernaut é uma força literal ou metafórica inpiedosamente destrutiva e imparável. Não há uma tradução exata para o português.<sup>2</sup> |
| Limit Break  | Quebrar Limites      |        |
| Offering     | Oferenda             |        |
| Reaper       | Ceifeiro             |        |
...
| Dagger Spray       | Borrifar Adagas      |        |
| Dagger Throw       | Arremessar Adaga     |        |
| Deadly Poison      | Veneno Mortal        |        |
| Deflect            | Defletir             | <sup>1</sup> |
...
| Backstab          | Atacar Pelas Costas  |        |
| Blade Dance       | Dança das Lâminas    |        |
| Blur              | Borrão               |        |
...
| Flechettes        | Flechettes           | <sup>2</sup> |
| Footwork          | Jogo de Pés          |        |
| Heel Hook         | Chave de Calcanhar   | <sup>3</sup> |
| Infinite Blades   | Lâminas Infinitas    |        |
| Leg Sweep         | Rasteira             |        |
| Malaise           | Mal-estar            |        |
| Masterful Stab    | Estocada Magistral   |        |
| Noxious Fumes     | Gases Nocivos        |        |
| Predator          | Predador             |        |
| Reflex            | Reflexo              |        |
| Riddle With Holes | Encher de Buracos    | Expressão em português equivalente. |
| Setup             | Preparar             |        |
...
| After Image        | Rastro                   | Afterimage é uma imagem que continua a aparecer na visão de alguém depois que a exposição à imagem original cessou. Não há uma tradução exata para o português.<sup>1</sup> |
...
| Envenom            | Envenenar                |        |
| Glass Knife        | Faca Vítrea              |        |
| Grand Finale       | Grand Finale             | Expressão francesa, também conhecida no Brasil. Não há necessidade de tradução. |
| Nightmare          | Pesadelo                 |        |
| Phantasmal Killer  | Assassino Fantasmagórico |        |
| Storm of Steel     | Tempestade de Aço        |        |
| Tactician          | Estrategista             |        |
| Tools of the Trade | Ferramentas do Ofício    | Expressão em português equivalente. |
| Unload             | Descarregar              |        |
...
### Colorless Cards | Cartas Incolores
...
| Bandage Up         | Enfaixar             |        |
| Blind              | Cegar                |        |
| Dark Shackles      | Grilhões Sombrios    |        |
| Deep Breath        | Respirar Fundo       |        |
| Dramatic Entrance  | Entrada Dramática    |        |
| Finesse            | Sutileza             |        |
| Flash of Steel     | Lampejo de Aço       |        |
| Good Instincts     | Bons Instintos       |        |
| Jack Of All Trades | Pau Para Toda Obra   | Expressão em português equivalente. |
| Madness            | Loucura              |        |
| Mind Blast         | Explosão Mental      |        |
| Panacea            | Panaceia             |        |
| Purity             | Pureza               |        |
...
| Master of Strategy | Mestre da Estratégia |        |
| Panache            | Desenvoltura         |        |
| Sadistic Nature    | Natureza Sádica      |        |
| Secret Technique   | Técnica Secreta      |        |
| Secret Weapon      | Arma Secreta         |        |
| Thinking Ahead     | Pensar à Frente      |        |
| Transmutation      | Transmutação         |        |

### Curse Cards | Cartas de Maldição
...
| English                       | Brazilian Portuguese | Reason |
| ----------------------------- | -------------------- | ------ |
| The Bomb<sup>1</sup>          | A Bomba              |        |
| Hide<sup>2</sup>              | Esconder-se          |        |
...
| English          | Brazilian Portuguese | Reason |
| ---------------- | -------------------- | ------ |
| Potion Slot      | Espaço de Poções     |        |
| Ancient Potion   | Poção Antiga         |        |
| Block Potion     | Poção de Proteção    |        |
| Dexterity Potion | Poção de Destreza    |        |
| Elixir           | Elixir               |        |
| Energy Potion    | Poção de Energia     |        |
| Explosive Potion | Poção de Explosão    |        |
| Fire Potion      | Poção de Fogo        |        |
| Health Potion    | Poção de Saúde       |        |
| Poison Potion    | Poção de Veneno      |        |
| Regen Potion     | Poção de Regeneração |        |
| Strength Potion  | Poção de Força       |        |
| Swift Potion     | Poção de Velocidade  |        |
| Weak Potion      | Poção de Fraqueza    |        |

## Achievements | Conquistas

| English           | Brazilian Portuguese       | Reason |
| ----------------- | -------------------------- | :----: |
| Shrug It Off      | Nem Ligar                  | O mesmo da carta "Shrug It Off". |
| Purity            | Pureza                     |        |
...
| The Pact          | O Pacto                    |        |
| Adrenaline        | Adrenalina                 | O mesmo da carta "Adrenaline". |
| Powerful          | Poderoso                   |        |
| Jaxxed            | Bombado                    | Ver carta "J.A.X.". |
| Impervious        | Impenetrável               | O mesmo da carta "Impervious". |
| Barricaded        | Inabalável                 | A ideia do termo barricaded é de se proteger atrás de uma barreira. A conquista é desbloqueada conseguindo 999 de Proteção. Inabalável é um sinônimo de "Impenetrável", e condiz com a conquista "Impervious", que é conseguida com 99 de Proteção. |
| Catalyst          | Catalizador                | O mesmo da carta "Catalyst". |
| Plague            | Praga                      |        |
| Ninja             | Ninja                      |        |
| Infinity          | Infinito                   |        |
